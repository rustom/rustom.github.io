...
const getOptions = pluginOptions => {
  const options = (0, _objectSpread2.default)({}, pluginOptions);
  ...
  return (0, _objectSpread2.default)({}, options, envOptions);
};
...
async function onPostBuild({
  ...
  const mergedOptions = (0, _objectSpread2.default)({}, defaultOptions, userOptions);

  if (!Object.prototype.hasOwnProperty.call(mergedOptions, 'host') || !Object.prototype.hasOwnProperty.call(mergedOptions, 'sitemap')) {
    const {
      site: {
        siteMetadata: {
          siteUrl
